...
### STtep 03: Create a `.env` file in the root directory and add your Pinecone & openai credentials as follows:
...
## 3. Create ECR repo to store/save docker image
    - Save the URI: 184588785028.dkr.ecr.eu-north-1.amazonaws.com/medical-chatbot
